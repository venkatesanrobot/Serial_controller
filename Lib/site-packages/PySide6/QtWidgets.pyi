...
class QColorDialog(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def getColor(initial:Union[PySide6.QtGui.QColor, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, str, int]=..., parent:Optional[PySide6.QtWidgets.QWidget]=..., title:str=..., options:PySide6.QtWidgets.QColorDialog.ColorDialogOptions=...) -> PySide6.QtGui.QColor: ...
    @overload
    def open(self) -> None: ...
    @overload
