...
enum : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 349,
    ...
    SBK_QRGBA64_IDX                                          = 242,
    SBK_QSCREEN_IDX                                          = 243,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 245,
    SBK_QSCROLLEVENT_IDX                                     = 244,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 246,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 248,
    SBK_QSESSIONMANAGER_IDX                                  = 247,
    SBK_QSHORTCUT_IDX                                        = 249,
    SBK_QSHORTCUTEVENT_IDX                                   = 250,
    SBK_QSHOWEVENT_IDX                                       = 251,
    SBK_QSINGLEPOINTEVENT_IDX                                = 252,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 254,
    SBK_QSTANDARDITEM_IDX                                    = 253,
    SBK_QSTANDARDITEMMODEL_IDX                               = 255,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 257,
    SBK_QSTATICTEXT_IDX                                      = 256,
    SBK_QSTATUSTIPEVENT_IDX                                  = 258,
    SBK_QSTYLEHINTS_IDX                                      = 259,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 261,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 262,
    SBK_QSURFACE_IDX                                         = 260,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 265,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 84,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 268,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 267,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 266,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 264,
    SBK_QSURFACEFORMAT_IDX                                   = 263,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 269,
    SBK_QTABLETEVENT_IDX                                     = 270,
    SBK_QTEXTBLOCK_IDX                                       = 271,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 272,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 350,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 274,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 273,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 275,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 276,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 280,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 279,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 278,
    SBK_QTEXTCHARFORMAT_IDX                                  = 277,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 282,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 283,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 284,
    SBK_QTEXTCURSOR_IDX                                      = 281,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 288,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 287,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 86,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 286,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 85,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 289,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 290,
    SBK_QTEXTDOCUMENT_IDX                                    = 285,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 291,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 292,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 294,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 297,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 295,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 296,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 87,
    SBK_QTEXTFORMAT_IDX                                      = 293,
    SBK_QTEXTFRAGMENT_IDX                                    = 298,
    SBK_QTEXTFRAME_IDX                                       = 299,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 300,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 303,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 302,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 301,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 304,
    SBK_QTEXTINLINEOBJECT_IDX                                = 305,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 307,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 88,
    SBK_QTEXTITEM_IDX                                        = 306,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 309,
    SBK_QTEXTLAYOUT_IDX                                      = 308,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 310,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 312,
    SBK_QTEXTLENGTH_IDX                                      = 311,
    SBK_QTEXTLINE_EDGE_IDX                                   = 315,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 314,
    SBK_QTEXTLINE_IDX                                        = 313,
    SBK_QTEXTLIST_IDX                                        = 316,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 318,
    SBK_QTEXTLISTFORMAT_IDX                                  = 317,
    SBK_QTEXTOBJECT_IDX                                      = 319,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 320,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 324,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 325,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 322,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 89,
    SBK_QTEXTOPTION_IDX                                      = 321,
    SBK_QTEXTOPTION_TAB_IDX                                  = 323,
    SBK_QTEXTTABLE_IDX                                       = 326,
    SBK_QTEXTTABLECELL_IDX                                   = 327,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 328,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 329,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 330,
    SBK_QTOUCHEVENT_IDX                                      = 331,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 333,
    SBK_QTRANSFORM_IDX                                       = 332,
    SBK_QUNDOCOMMAND_IDX                                     = 334,
    SBK_QUNDOGROUP_IDX                                       = 335,
    SBK_QUNDOSTACK_IDX                                       = 336,
    SBK_QVALIDATOR_STATE_IDX                                 = 338,
    SBK_QVALIDATOR_IDX                                       = 337,
    SBK_QVECTOR2D_IDX                                        = 339,
    SBK_QVECTOR3D_IDX                                        = 340,
    SBK_QVECTOR4D_IDX                                        = 341,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 342,
    SBK_QWHEELEVENT_IDX                                      = 343,
    SBK_QWINDOW_VISIBILITY_IDX                               = 346,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 345,
    SBK_QWINDOW_IDX                                          = 344,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 347,
    SBK_QtGuiQT_IDX                                          = 348,
    SBK_QtGui_IDX_COUNT                                      = 351
};
...
enum : int {
    ...
    SBK_QTGUI_QLIST_UINT16_T_IDX                             = 20, // QList<uint16_t >
    SBK_QTGUI_QLIST_QACCESSIBLEINTERFACEPTR_IDX              = 21, // QList<QAccessibleInterface* >
    SBK_QTGUI_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 22, // QPair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag> >
    SBK_QTGUI_QLIST_QPAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 23, // QList<QPair< QAccessibleInterface*,QFlags<QAccessible::RelationFlag> > >
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 24, // QList<unsigned int >
    SBK_QTGUI_QLIST_QLINE_IDX                                = 25, // QList<QLine >
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 26, // QList<QLineF >
    SBK_QTGUI_QLIST_QRECT_IDX                                = 27, // QList<QRect >
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 28, // QList<QRectF >
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 29, // QList<QKeySequence >
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 30, // QList<QObject* >
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 31, // QList<QByteArray >
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 32, // QList<QUndoStack* >
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 33, // QList<QTextFrame* >
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 34, // QList<QTextBlock >
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 35, // QList<QTextFormat >
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 36, // QList<QScreen* >
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 37, // QList<QOpenGLContext* >
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 38, // QSet<QByteArray >
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 39, // QList<const QInputDevice* >
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 40, // QList<QAction* >
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 41, // QList<QInputMethodEvent::Attribute >
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 42, // QList<QEventPoint >
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 43, // QList<QWindow* >
    SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                = 44, // QList<QPersistentModelIndex >
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 45, // QHash<int,QByteArray >
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 46, // QList<QVariant >
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 47, // QList<QString >
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 48, // QMap<QString,QVariant >
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 49
};
